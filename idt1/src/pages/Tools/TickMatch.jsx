...
export default function TickMatch() {
                ...
                <div className="relative flex flex-col h-full bg-[#111827] border border-slate-700 rounded-lg shadow-lg z-10 overflow-visible">
                    ...
                    <div className="shrink-0 p-2 pt-4 bg-[#111827] rounded-t-lg">
                        <div className="flex items-end gap-1.5 mb-3">
                            ...
                            {/* DATE */}
                            <div className="flex-1 relative">
                                <label className="absolute left-1.5 -top-2 text-[9px] px-1 bg-[#111827] text-slate-400 font-bold z-10 uppercase">Date</label>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 py-8 flex flex-col items-center">
                <div className="text-center mb-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-tight">
                        <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">TickMatch</span>
                    </h1>
                ...
                <div className="relative group w-full max-w-5xl mb-16">
                    ...
                    <div className="relative bg-[#0B1221] border border-slate-700/50 rounded-2xl overflow-hidden shadow-2xl">
                        <div className="aspect-[16/9] w-full bg-[#0B1221]"><TickMatchDashboard /></div>
                    </div>
                </div>
                ...
                <div className="text-center w-full max-w-md mx-auto mt-4">
                    {showStartBtn ? (
                        <button onClick={() => { setEnteredTool(true); localStorage.setItem("TickMatchToolEntered", "true"); }} className="px-8 py-3.5 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold shadow-lg hover:scale-105 transition-all">Start Using Tool</button>
                    ) : (
   ...
   // ส่วน Dashboard จริง
    return (
        <div className="w-full min-h-screen bg-[#0b111a] text-white px-3 md:px-6 py-3 md:py-6 flex flex-col pb-20">
            <div className="w-full max-w-[1800px] mx-auto flex-1 flex flex-col">
                <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 pt-4">
                    <AnalysisPanel
                        toolHint={
